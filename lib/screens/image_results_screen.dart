...
class ImageResultsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final description = mlKitService.generateDescription(detectedItems);
  ...
  Widget _buildDetectedItemsList(ThemeData theme) {
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 8,
            decoration: BoxDecoration(
              color: _getConfidenceColor(item.confidence, theme),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: _getConfidenceColor(item.confidence, theme).withOpacity(0.1),
              borderRadius: BorderRadius.circular(12),
            ),
            child: Text(
